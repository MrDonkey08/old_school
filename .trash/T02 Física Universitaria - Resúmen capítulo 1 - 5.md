...
![](/Attachments/Images/Notación-de-Unidades-de-Medición.jpeg)
...
<!-- $\vec a = \frac{d^2x}{dt}\hat\imath + \frac{d^2y}{dt}\hat\jmath + \frac{d^2z}{dt}\hat k$ -->
...
$\tan\alpha = \frac{v_y}{v_x}$
<!-- $y=(\tan\alpha_0)x-\frac{5}{2{v_0}^2\cos^2\alpha_0}x^2$ -->
